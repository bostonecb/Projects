...
- **Key Features:**
  - **Django Backend:** Server-side logic and data management built with Django, supporting core social networking functionality.
  - **Responsive Frontend:** Dynamic and mobile-friendly UI built with HTML, CSS, and JavaScript.
